...
export default class Search {
  ...
  renderResultsHTML(posts) {
    if (posts.length) {
      ...
      <div class="list-group-item active"><strong>Résultat : </strong> (${posts.length > 1 ? `${posts.length} résultats trouvés` : "1 résultat trouvé"})</div>
      ${posts
        .map(post => {
      ...
      this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Désolé, nous n'avons trouvé aucun résultat pour ta recherche...</p>`
    }
    this.hideLoaderIcon()
  ...
  injectHTML() {
    ...
    <div class="search-overlay-top shadow-sm">
      <div class="container container--narrow">
        ...
        <input autocomplete="off" type="text" id="live-search-field" class="live-search-field" placeholder="Quels sont des centres d'intérêt?">
